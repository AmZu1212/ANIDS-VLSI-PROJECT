...
`define LOOKUP_LAYER_CYCLES 		64
`define LOSS_FUNCTION_CYCLES 		64
`define OUTLIER_CYCLES 				1
`define RESULT_CYCLES 				1


// Pipeline Fill and Latency in cycles (pipefill = 259, latency = 130)
`define PIPE_FILL_CYCLES 			(`INPUT_LAYER_CYCLES + `HIDDEN_LAYER_CYCLES + `OUTPUT_LAYER_CYCLES + `LOOKUP_LAYER_CYCLES + `LOSS_FUNCTION_CYCLES + `OUTLIER_CYCLES + `RESULT_CYCLES)
`define LATENCY_IN_CYCLES 			(`LOOKUP_LAYER_CYCLES + `LOSS_FUNCTION_CYCLES + `OUTLIER_CYCLES + `RESULT_CYCLES )
