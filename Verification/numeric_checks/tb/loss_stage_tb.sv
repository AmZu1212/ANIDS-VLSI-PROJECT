...
module loss_stage_tb;
	localparam integer CASE_COUNT = 30;
	localparam string GENERATED_DIR = "Verification/numeric_checks/generated/loss";
	...
	begin
		...
		if (ready !== 1'b1) begin
			$error("Loss stage ready failure case=%0d", idx);
			$finish;
		end
