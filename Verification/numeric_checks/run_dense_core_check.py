...
from Verification.numeric_checks.dense_core_case import generate_dense_core_case
...
def main() -> int:
    ...
    proc = subprocess.run(
        [sys.executable, "run.py", "Verification/numeric_checks/tb/dense_core_stress_tb.sv"],
        cwd=ROOT,
        capture_output=True,
        text=True,
        check=False,
